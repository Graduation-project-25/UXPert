...
class Suggestions(SuggestionsGenerator):
    ...
    def generate_suggested_image(self, generated_text_suggestions): 
        ...
        with open("test 2-modified.png", "wb") as f:
            f.write(image_bytes)
    ...
    def generate_suggestions(self, frame_image):
        generated_text_suggestions = self.analyze_design(frame_image)
